...
public class WXBizMsgCrypt {
	...
	private static final Logger logger = LogManager.getLogger(WXBizMsgCrypt.class);
	...
	public WXBizMsgCrypt(String token, String encodingAesKey, String corpId) throws AesException {
		logger.info("token={} , encodingAesKey={} , size ={}" , token , encodingAesKey , encodingAesKey.length());
